...
var EventClass = {
  UNKNOWN_EVENT: 'Unkown',
  QUERY_EVENT: 'Query',
  ROTATE_EVENT: 'Rotate',
  FORMAT_DESCRIPTION_EVENT: 'Format',
  XID_EVENT: 'Xid',

  TABLE_MAP_EVENT: 'TableMap',
  DELETE_ROWS_EVENT_V1: 'DeleteRows',
  UPDATE_ROWS_EVENT_V1: 'UpdateRows',
  WRITE_ROWS_EVENT_V1: 'WriteRows',
  WRITE_ROWS_EVENT_V2: 'WriteRows',
  UPDATE_ROWS_EVENT_V2: 'UpdateRows',
  DELETE_ROWS_EVENT_V2: 'DeleteRows',
};
