...
TableMap.prototype.updateColumnInfo = function() {
  ...
  for (var j = 0; j < this.columnCount; j++) {
    ...
    if (columnSchema.CONSTRAINT_TYPE) {
      column.constraint = {
        type: columnSchema.CONSTRAINT_TYPE,
        position: columnSchema.ORDINAL_POSITION,
        name: columnSchema.CONSTRAINT_NAME
      };
    }
