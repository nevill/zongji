...
TableMap.prototype.updateColumnInfo = function() {
  ...
  for (var j = 0; j < this.columnCount; j++) {
    columns.push({
      ...
      constraintType: columnSchemas[j].CONSTRAINT_TYPE,
      unique: columnSchemas[j].CONSTRAINT_TYPE === 'UNIQUE',
      pk: columnSchemas[j].CONSTRAINT_TYPE === 'PRIMARY KEY',
      nullable: columnSchemas[j].IS_NULLABLE,
